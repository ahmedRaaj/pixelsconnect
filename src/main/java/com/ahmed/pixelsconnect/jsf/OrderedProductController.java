package com.ahmed.pixelsconnect.jsf;

import com.ahmed.pixelsconnect.domain.OrderedProduct;
import com.ahmed.pixelsconnect.jsf.util.JsfUtil;
import com.ahmed.pixelsconnect.jsf.util.PaginationHelper;
import com.ahmed.pixelsconnect.facade.OrderedProductFacade;
...
public class OrderedProductController implements Serializable {
    ...
    @EJB
    private com.ahmed.pixelsconnect.facade.OrderedProductFacade ejbFacade;
    ...
    public OrderedProduct getSelected() {
        if (current == null) {
            ...
            current.setOrderedProductPK(new com.ahmed.pixelsconnect.domain.OrderedProductPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public OrderedProduct getOrderedProduct(com.ahmed.pixelsconnect.domain.OrderedProductPK id) {
    ...
    public static class OrderedProductControllerConverter implements Converter {
        ...
        com.ahmed.pixelsconnect.domain.OrderedProductPK getKey(String value) {
            com.ahmed.pixelsconnect.domain.OrderedProductPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.ahmed.pixelsconnect.domain.OrderedProductPK();
            key.setProductid(Integer.parseInt(values[0]));
            key.setCustomerOrderId(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.ahmed.pixelsconnect.domain.OrderedProductPK value) {
